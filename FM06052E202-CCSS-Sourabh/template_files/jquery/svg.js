...
$(document).ready(function(){
	...
	$(".Step1,.solutionText,.oogive,.oogive1,.circle4,.circle5,.circle6").hide();					   
...
//////////////end new/////////////////////
		...
		$(".txt1,.txt2,.txt3,.txt4,.txt5,.txt6,.txt7,.crcle1,.crcle2,.crcle3,.crcle4,.crcle5,.crcle11,.crcle21,.crcle31,.crcle41,.crcle51,.circle4,.circle5,.circle6").css("display","none");
		$(".crcl").css("opacity" , "0");
		////alert()
		/*$("svg").each(function() {
							  // //alert("inside")
