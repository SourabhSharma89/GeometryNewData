...
//console.log((CoOrdinateX3+" =3= "+String(ans_arr[i]).split("@")[0])+" && "+(CoOrdinateY3+" == "+String(ans_arr[i]).split("@")[1])+" ("+String(ans_arr[i]).split("@")[2]+", "+String(ans_arr[i]).split("@")[3])
				...
				if(score6==1){
					...
					if( CoOrdinateX3 == 0 && ent_ans1 == "" && ent_ans2 == "" && ent_ans3 == ""){$(".blank").html("Plot the");$(".blank1").html("Points.");$(".blankMessage_New").show();$(".Wrng,.Wrt").hide()
						//////alert()	
						Responseflag="false";
						var FeedbackText = "";
						$(".respond").html("")
			...
			//////////////////////////////////////////////////////////////////
					...
					//////////////alert($(temp1+"")
					localStorage.setItem("key",$('.input1').val()+"@serverString@"+$('.input2').val()+"@serverString@"+$('.input3').val()+"@serverString@"+temp1+"@serverString@"+score1+"@serverString@"+score2+"@serverString@"+score3+"@serverString@"+final_score+"@serverString@"+Attempted_score+"@serverString@"+finalScore+"@serverString@"+score4+"@serverString@"+$('.input4').val()+"@serverString@"+CoOrdinateX1+"@serverString@"+CoOrdinateY1+"@serverString@"+CoOrdinateX2+"@serverString@"+CoOrdinateY2+"@serverString@"+CoOrdinateX3+"@serverString@"+CoOrdinateY3+"@serverString@"+score5+"@serverString@"+option1+"@serverString@"+finalScore1+"@serverString@"+FromInnerText);
					////////////////////////alert("jjjj")
