$(document).ready(function(){
	...
	$(".keypadKeys").css("padding-bottom",calc_btnHeight/3+"px");
...
if(checkMobile){if (window.innerHeight < window.innerWidth) {$(".RootInfoDevice").css({"width":KeypadBoundaryWidthDevice-25+"px"});}}
